...
<div class="grid">
    <?php $form = ActiveForm::begin(['id' => 'form-signup', 'options' => ['class' => 'form login']]); ?>
        ...
        <?= $form->field($model, 'email', ['options' => ['class' => 'form__field']])->textInput(['class' => 'form__input', 'placeholder' => $model->getAttributeLabel('email')])->label('<svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mail"></use></svg>') ?>
    ...
    <?php ActiveForm::end(); ?>
    <p class="text--center">
        Есть аккаунт?__ <?= Html::a('login', ['site/login']) ?>
    </p>
</div>
