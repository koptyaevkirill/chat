...
<div class="grid">
    ...
    <?php $form = ActiveForm::begin(['id' => 'reset-password-form', 'options' => ['class' => 'form login']]); ?>
        <?= $form->field($model, 'password', ['options' => ['class' => 'form__field']])->textInput(['class' => 'form__input', 'placeholder' => $model->getAttributeLabel('password')])->label('<svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg>') ?>
